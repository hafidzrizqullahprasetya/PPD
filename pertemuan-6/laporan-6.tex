...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-4-k-means-step-1.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-5-k-means-step-2.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.62\textwidth]{images/gambar-6-2-6-k-means-convergence.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.65\textwidth]{images/gambar-6-2-7-k-means-outlier-problem.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.68\textwidth]{images/gambar-6-2-7b-menentukan-k-elbow-silhouette.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.68\textwidth]{images/gambar-6-2-8-k-medoids-vs-k-means.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-10-k-medoids-pam-error-criterion.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-11-k-medoids-pam-cost-function.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.68\textwidth]{images/gambar-6-2-12-dbscan-density-clusters.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.65\textwidth]{images/gambar-6-2-13-why-dbscan-comparison.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-14-dbscan-core-object.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-15-dbscan-point-types.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.45\textwidth]{images/gambar-6-2-16-dbscan-k-dist-graph.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.48\textwidth]{images/gambar-6-2-17-association-rule-transactions.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-17b-association-rule-metrics.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-17c-association-rule-example.png}}
...
\begin{minipage}[b]{0.46\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-18-apriori-principle.png}}
...
\begin{minipage}[b]{0.50\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/gambar-6-2-20-apriori-lattice-superset.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.50\textwidth]{images/gambar-6-2-19-apriori-lattice-pruning.png}}
...
Percobaan latihan praktikum mengimplementasikan segmentasi nasabah kartu kredit memakai \textit{Credit Card Dataset for Clustering} (\texttt{CC GENERAL.csv}) \cite{kaggle-ccdata}. Seluruh tahapan eksperimen latihan dan tugas pada laporan ini telah diimplementasikan serta dapat diakses dan dijalankan secara interaktif melalui Google Colaboratory pada tautan berikut:

\begin{center}
\href{https://colab.research.google.com/drive/143E58VDNkkjOdFiezQN4yGggLJ6_xo5j?usp=sharing}{\textcolor{blue}{\url{https://colab.research.google.com/drive/143E58VDNkkjOdFiezQN4yGggLJ6_xo5j?usp=sharing}}} \cite{colab-notebook}
\end{center}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-01-import-pustaka.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-02-baca-dataset.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.85\textwidth]{images/ss-03-struktur-dataset.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-04-korelasi.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-05-drop-custid.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.45\textwidth]{images/ss-06-null-awal.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.85\textwidth]{images/ss-07-imputasi.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.55\textwidth]{images/ss-08-null-akhir.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.85\textwidth]{images/ss-09-scaling.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.85\textwidth]{images/ss-10-inertia-kmeans.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.75\textwidth]{images/ss-12-kneed-kmeans.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-11-plot-elbow-kmeans.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-13-kneedle-plot-kmeans.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.75\textwidth]{images/ss-14-inertia-kmedoids.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-15-plot-elbow-kmedoids.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-16-kneed-kmedoids.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-17-sil-score-kmeans.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-18-plot-sil-kmeans.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-19-sil-score-kmedoids.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-20-plot-sil-kmedoids.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.85\textwidth]{images/ss-21-train-kmeans.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.75\textwidth]{images/ss-22-centroids-kmeans.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-23-scatter-matplotlib-kmeans.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-24-scatter-seaborn-kmeans.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.8\textwidth]{images/ss-25-scatter-3d-kmeans.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.8\textwidth]{images/ss-26-train-kmedoids.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-27-scatter-matplotlib-kmedoids.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-28-scatter-seaborn-kmedoids.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.65\textwidth]{images/ss-29-tabel-profiling.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.72\textwidth]{images/ss-30-barplot-profiling.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.75\textwidth]{images/ss-31-tugas-air-load.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.7\textwidth]{images/ss-32-tugas-air-scaling.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-33-tugas-air-elbow.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-34-tugas-air-sil.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.75\textwidth]{images/ss-35-tugas-air-train.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-36-tugas-air-scatter-km.png}}
...
\begin{minipage}[b]{0.48\textwidth}
    \centering
    \customfbox{\includegraphics[width=\dimexpr\linewidth-1pt\relax]{images/ss-37-tugas-air-scatter-kmed.png}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.75\textwidth]{images/ss-38-apriori-calc.png}}
...
\begin{thebibliography}{99}
    ...
    \bibitem{colab-notebook} H. R. Prasetya, ``Praktikum 6: Clustering dan Association Rule (Notebook),'' Google Colaboratory, 2026. [Online]. Tersedia: \url{https://colab.research.google.com/drive/143E58VDNkkjOdFiezQN4yGggLJ6_xo5j?usp=sharing}.
\end{thebibliography}

...
\begin{figure}[H]
\centering
\fbox{\parbox[c][4cm][c]{0.9\textwidth}{\centering PLACEHOLDER\\Screenshot histogram variabel numerik Bengaluru}}
\caption{Distribusi variabel numerik dataset Bengaluru.}
\label{fig:tugas-bengaluru-hist}
\end{figure}

Berdasarkan histogram yang dihasilkan, terlihat bahwa:
\begin{itemize}
    \item \texttt{bath}: Distribusi cenderung \textit{right-skewed}, mayoritas properti memiliki 2--3 kamar mandi, dengan sedikit properti yang memiliki lebih dari 5 kamar mandi.
    \item \texttt{balcony}: Distribusi juga \textit{right-skewed}, sebagian besar properti memiliki 1--2 balkon, dan sangat sedikit yang memiliki lebih dari 3 balkon.
    \item \texttt{price}: Distribusi sangat \textit{right-skewed} dengan \textit{long tail}, mayoritas properti berada di rentang harga rendah (di bawah 200), namun terdapat outlier dengan harga sangat tinggi hingga 3.600.
\end{itemize}
...
\begin{figure}[H]
\centering
\fbox{\parbox[c][4cm][c]{0.9\textwidth}{\centering PLACEHOLDER\\Screenshot korelasi variabel numerik Bengaluru}}
...
\begin{itemize}
    \item \texttt{bath} dan \texttt{price} memiliki korelasi positif yang cukup kuat (sekitar 0.5--0.6), artinya semakin banyak kamar mandi, harga properti cenderung semakin tinggi.
    \item \texttt{balcony} dan \texttt{price} memiliki korelasi positif lemah (sekitar 0.1--0.2), artinya jumlah balkon tidak terlalu memengaruhi harga.
    \item \texttt{bath} dan \texttt{balcony} memiliki korelasi positif lemah, menunjukkan keduanya relatif independen.
\end{itemize}
...
\begin{figure}[H]
\centering
\fbox{\parbox[c][4cm][c]{0.9\textwidth}{\centering PLACEHOLDER\\Screenshot preprocessing lanjutan Bengaluru}}
\caption{Hasil encoding, train-test split, dan scaling dataset Bengaluru.}

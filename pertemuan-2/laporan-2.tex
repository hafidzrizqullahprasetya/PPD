...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-03-bengaluru-hist-corr-preprocessing.jpg}}
\caption{Histogram variabel numerik, matriks korelasi, dan hasil preprocessing dataset Bengaluru.}
\label{fig:tugas-bengaluru-hist-corr-preprocessing}
\end{figure}
...
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-03-bengaluru-hist-corr-preprocessing.jpg}}
\caption{Matriks korelasi variabel numerik dataset Bengaluru (bagian dari Gambar \ref{fig:tugas-bengaluru-hist-corr-preprocessing}).}
...
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-03-bengaluru-hist-corr-preprocessing.jpg}}
\caption{Hasil encoding, train-test split, dan scaling dataset Bengaluru (bagian dari Gambar \ref{fig:tugas-bengaluru-hist-corr-preprocessing}).}

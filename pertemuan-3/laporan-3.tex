...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{images/knn-workflow-diagram.jpg}}
...
\end{equation}
Pemilihan nilai $k$ berpengaruh besar: $k$ yang terlalu kecil sensitif terhadap noise, sedangkan $k$ yang terlalu besar dapat memasukkan titik dari kelas lain. KNN juga sensitif terhadap skala fitur, sehingga scaling dianjurkan \cite{sklearn-preprocessing}.
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.85\textwidth]{images/decision-tree-buys-computer.jpg}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{images/bagging-illustration.jpg}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{images/confusion-matrix-structure.jpg}}
...
Pada bagian ini saya mendokumentasikan percobaan klasifikasi sesuai langkah pada Modul Pertemuan 3. Dataset yang digunakan adalah \textit{Stroke Prediction Dataset} dari Kaggle~\cite{kaggle-stroke} (\url{https://www.kaggle.com/datasets/fedesoriano/stroke-prediction-dataset}) yang juga tersedia di GitHub \texttt{ganjar87/data\_science\_practice}. Setiap langkah disertai kode yang saya jalankan di Google Colaboratory beserta screenshot hasil eksekusinya. Notebook yang saya gunakan dapat diakses melalui tautan Google Colab berikut: \url{https://colab.research.google.com/drive/1u5hrJQDwnOMdlWAobI8k7-zzQ_X5HPU0?usp=sharing}.

\subsection{Alat dan Bahan}
Sesuai Modul 3.3, alat dan bahan yang saya gunakan adalah:
\begin{itemize}
    \item \textbf{Perangkat keras:} Laptop/komputer dengan akses internet.
    \item \textbf{Perangkat lunak:} Python~3~\cite{python-docs} dan Google Colaboratory sebagai lingkungan eksekusi notebook. Pustaka utama yang saya gunakan meliputi pandas~\cite{pandas-docs}, NumPy~\cite{numpy-docs}, Matplotlib, Seaborn, dan Scikit-Learn untuk preprocessing serta pemodelan klasifikasi \cite{sklearn-metrics,sklearn-preprocessing}.
\end{itemize}
Dataset stroke saya akses melalui mirror GitHub agar dapat dimuat langsung dengan \texttt{pd.read\_csv()} tanpa unduhan manual dari Kaggle, sedangkan dataset tugas loan saya akses melalui mirror \texttt{shrikant-temburwar/Loan-Prediction-Dataset} di GitHub.

\subsection{Persiapan dan Impor Pustaka}
Saya menyiapkan lingkungan Python~\cite{python-docs} dan mengimpor pustaka yang dibutuhkan untuk manipulasi data dengan pandas~\cite{pandas-docs}, komputasi numerik dengan NumPy~\cite{numpy-docs}, visualisasi, dan pemodelan klasifikasi.
...
\subsubsection{Persentase Target Kelas}
Saya memvisualisasikan distribusi target menggunakan pie chart.

\begin{lstlisting}[style=pythonstyle,caption={Persentase target kelas.}]
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-05-pie-target.jpg}}
\caption{Pie chart distribusi variabel target \texttt{stroke}: kelas 0 (tidak stroke) 95,13\% dan kelas 1 (stroke) 4,87\%, sehingga dataset bersifat imbalanced.}
\label{fig:ss05-pie}
\end{figure}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.7\textwidth]{images/ss-06-histogram-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-07-histogram-result.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.7\textwidth]{images/ss-09-categorical.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-10-preprocessing-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-11-X-numeric.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-12-y-encoded.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-13-X-train-scaled.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-14-X-test-scaled.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-15-logreg-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-16-logreg-performance.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-17-logreg-cm.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-18-logreg-f1.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-19-logreg-coef.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-20-logreg-intercept.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-21-knn-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-22-knn-performance.jpg}}
\caption{Output performa KNN: Accuracy 0.9419, Precision 0.4709, Recall 0.5000, Confusion Matrix [[1444, 0], [89, 0]], identik dengan Logistic Regression dan gagal mendeteksi kelas minoritas.}
\label{fig:ss22-knn-perf}
\end{figure}

\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-23-knn-cm.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-24-dt-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-25-dt-performance.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-26-dt-cm.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-27-rf-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-28-rf-performance.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-29-rf-cm.jpg}}
\caption{Confusion Matrix Random Forest: hampir identik dengan Logistic Regression, model konservatif pada kelas minoritas.}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-30-adaboost-code.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-31-adaboost-performance.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.6\textwidth]{images/ss-32-adaboost-cm.jpg}}
...
loan_url = 'https://raw.githubusercontent.com/shrikant-temburwar/Loan-Prediction-Dataset/master/train.csv' # mirror GitHub dari Kaggle
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-01-loan-head.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-02-loan-eda.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-03-loan-preprocessing.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-04-loan-logreg.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-05-loan-knn.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-06-loan-dt.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-07-loan-rf.jpg}}
...
\begin{figure}[H]
\centering
\customfbox{\includegraphics[width=0.9\textwidth]{images/ss-tugas-08-loan-tabel-performa.jpg}}

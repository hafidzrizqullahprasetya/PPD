...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.7\textwidth]{images/teori-supervised.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.6\textwidth]{images/teori-timeseries.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{images/teori-04-one-vs-multistep.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{images/teori-01-sliding-window.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{images/teori-03-fitur-statistik.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.5\textwidth]{images/teori-mlp.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.55\textwidth]{images/teori-knn.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.7\textwidth]{images/teori-decision-tree.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.5\textwidth]{images/teori-overfitting.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.5\textwidth]{images/teori-svr.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{images/teori-random-forest.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.95\textwidth]{images/teori-pearson.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.9\textwidth]{images/teori-02-split-kronologis.png}}
...
Bagian ini mendokumentasikan percobaan \textit{forecasting} sesuai langkah pada Modul Pertemuan 5. Dataset yang dipakai adalah \textit{Bike Sharing Dataset} \cite{kaggle-bike}, yang berisi catatan peminjaman sepeda harian beserta kondisi cuaca. Saya memuat data dari mirror GitHub \cite{bike-mirror} agar bisa langsung dibaca dengan \texttt{pd.read\_csv()} tanpa unduhan manual.

Notebook praktikum ini dapat dijalankan langsung melalui Google Colab pada tautan berikut (salinannya juga tersedia pada repositori ini sebagai \texttt{praktikum-5-forecasting.ipynb}):

\begin{center}
\href{https://colab.research.google.com/github/hafidzrizqullahprasetya/PPD/blob/main/pertemuan-5/praktikum-5-forecasting.ipynb}{\textcolor{blue}{https://colab.research.google.com/github/hafidzrizqullahprasetya/PPD/blob/main/pertemuan-5/praktikum-5-forecasting.ipynb}} \cite{colab-notebook}
\end{center}
